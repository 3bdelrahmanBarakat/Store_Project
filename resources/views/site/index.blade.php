...
@section('body')
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="{{asset('8c2d576c31.jpg')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
    ...
    <div class="title1 section-t-space">
        <h4>Immediate SHEIN Items <i class="fa fa-plane"></i> </h4>
    </div>
        ...
        <div class="container">
            ...
            <div class="row margin-default ratio_square">
                ...
                <div class="col-xl-2 col-sm-3 col-4">
                    <a href="http://127.0.0.1:8000/products/filter?category_id={{$category->id}}">
                        <div class="img-category">
                            <div class="img-sec">
                                <img src="{{asset($category->image)}}" class="img-fluid bg-img" alt="">
                            </div>
                            <h4>{{$category->name}}</h4>
                        </div>
                    </a>
            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="product-para">
                    <p class="text-center">Looking for the latest trends in clothing, shoes and accessories? Welcome to
                        our 'Latest Drops' edit, bringing you all the latest styles from all your fav brands.</p>
                </div>
            </div>
        </div>
    </div>
