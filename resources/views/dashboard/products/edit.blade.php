                            ...
                            <div class="digital-add needs-validation">
                                <form action="{{ route('dashboard.products.update', $product->id) }}" method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <label for="validationCustom05" class="col-form-label pt-0">
                                                Size chart <small>(optional)</small>  </label>
                                            <input class="form-control dropify" id="validationCustom05" type="file"
                                                name="size_chart" data-default-file="{{asset($product->size_chart)}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="validationCustom02" type="text" name="quantity" value="{{$product->quantity}}">
                                        ...
                                        <div class="form-group">
                                            <label for="validationCustom02" class="col-form-label">
                                                تاريخ الاضافه  </label>
                                            <input class="form-control" id="validationCustom02" type="datetime-local" name="created_at" value="{{ $product->created_at->format('Y-m-d\TH:i') }}">
                                ...
                                @foreach($product->images as $image)
                                    <div class="col-md-3">
                                        ...
                                        <form action="{{route('dashboard.products.image.delete',$image->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit">
